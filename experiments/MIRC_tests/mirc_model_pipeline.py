...
attention_path = '/home/drew/Documents/MIRC_behavior/heat_map_output/pooled_p2p_alt/uniform_weight_overlap_human/heatmaps.npz' #or None
im_ext = '.JPEG'
im_size = [224,224]
grayscale=False
attention_conv = '2_2'
...
if attention_path != None:
    import_model(model_type,True)
...
with tf.device('/gpu:0'):
    with tf.Session(
        ...
        vgg = nn_model.Vgg16(vgg16_npy_path=weight_path)
...
print('t1 p = ',t1_true_acc)
print('t5 p = ',t5_true_acc)
