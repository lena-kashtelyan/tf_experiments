...
from tf_experiments.model_depo import att_vgg19 as vgg19

def svm_attention_vgg19():
    ...
    np.savez('svm_data/attention_svm_data_vgg19',fc_batches=fc_batches,gt=gt,gt_ids=gt_ids,test_names=test_names,full_syn=full_syn)
