...
from att_resnet import attResNet50, attResNet101, attResNet152
...
attResNet50, attResNet101, attResNet152)
...
MODEL_DATA_SPECS = {
    ...
    attResNet50: std_spec(batch_size=25),
    attResNet101: std_spec(batch_size=25),
    attResNet152: std_spec(batch_size=25),    
}
